...
1- Se cosidera, interpretado de los comentarios
del profesor, que los semaforos permiten ingresar 
a las avenidas secundarios solo saliendo por la 
derecha, más no por la izquierda (Practica muy 
empleada en la cidudad donde vivo). Mientras que 
desde las avenidas secuandarias se puede ingresar
a la principal girando tanto a izquierda como a
derecha.

2- Esto nos deja con un sistema de semáforos de 3
movimientos. Una secuencia para la avenidad principal
(en ambos sentidos) y dos secuanecias independientes 
para cada avendida secuandaria.
...
estatica por 50s y luego parapadeara por otros 10s.

4- Si un peaton pulsase el botón de cruce, deberá esperar
a que la secuancia en ejecucución se detenga, y luego
